...
import ErrorAlert from 'src/components/console/console-shared/alerts/error';
import { LoadingInline } from 'src/components/console/utils/status-box';
import { usePatternFlyTheme } from './usePatternflyTheme';
...
type PrometheusInstance = string;

interface PersesPrometheusDatasourceWrapperProps {
  prometheus: PrometheusInstance | undefined;
